        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-center space-x-4 text-yellow-400">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/packages/1">View Details</Link>
            </Button>
          </div>
        </div>
      </section>
              ...
              >
                <div className="relative">
                  ...
                  <Badge className="absolute top-4 right-4 bg-red-600 shadow-lg">
                    Save Rs{" "}
                    {Number.parseInt(pkg.originalPrice.replace("Rs ", "").replace(",", "")) -
                      Number.parseInt(pkg.price.replace("Rs ", "").replace(",", ""))}
                  </Badge>
                </div>
                ...
                <CardContent className="text-white">
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-2">
                      <Button
                        className="flex-1 bg-gradient-to-r from-yellow-400 to-amber-500 text-black hover:from-yellow-500 hover:to-amber-600 font-semibold shadow-lg hover:shadow-yellow-500/50 transition-all duration-300"
                        asChild
                      >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link href="/packages?type=hajj-packages" className="hover:text-yellow-400 transition-colors">
                    Hajj Packages
                  </Link>
                </li>
                <li>
                  <Link href="/packages?type=umrah-packages" className="hover:text-yellow-400 transition-colors">
                    Umrah Packages
                  </Link>
                </li>
                <li>
